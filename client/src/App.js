  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <h2>Buy Tokens</h2>
        <p>If yot want to buy tokens, send Wei to this address: {this.state.tokenSaleAddress}</p>
        <p>You have tokens: {this.state.userTokens}</p>
